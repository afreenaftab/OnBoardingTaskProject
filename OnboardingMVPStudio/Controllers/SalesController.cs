...
using OnboardingMVPStudio.Models;

namespace OnboardingMVPStudio.Controllers
{
    public class SalesController : Controller
    {
        private readonly MVPSTUDIOContext _context;

        public SalesController(MVPSTUDIOContext context)
        {
            _context = context;
        }
        ...
        {
            var mVPSTUDIOContext = _context.Sales.Include(s => s.Customer).Include(s => s.Product).Include(s => s.Store);
            return View(await mVPSTUDIOContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVPSTUDIOContext.Sales'  is null.");
            }
            var sale = await _context.Sales.FindAsync(id);
            if (sale != null)
            {

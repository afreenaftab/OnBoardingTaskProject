...
namespace OnboardingMVPStudio.Controllers
{
    public class StoresController : Controller
    {
        ...
        public StoresController(MVPSTUDIOContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Stores != null ? 
                          ...
                          Problem("Entity set 'MVPSTUDIOContext.Stores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVPSTUDIOContext.Stores'  is null.");
            }
            var store = await _context.Stores.FindAsync(id);
            if (store != null)
            {
